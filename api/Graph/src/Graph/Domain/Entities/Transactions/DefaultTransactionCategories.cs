...
public static class DefaultTransactionCategories
{
    ...
    private static readonly Lazy<IReadOnlyList<DefaultTransactionCategory>> _asList
        = new(() => new List<DefaultTransactionCategory>()
        {
                ...
                new ("RENT_AND_UTILITIES", null, null, new DefaultTransactionCategory[]{                    new("RENT_AND_UTILITIES_GAS_AND_ELECTRICITY", "Gas and electricity bills", "RENT_AND_UTILITIES", null),
                ...
                new ("GOVERNMENT_AND_NON_PROFIT", null, null, new DefaultTransactionCategory[]{                    new("GOVERNMENT_AND_NON_PROFIT_DONATIONS", "Charitable, political, and religious donations", "GOVERNMENT_AND_NON_PROFIT", null),
                ...
                new ("INCOME", null, null, new DefaultTransactionCategory[]{                    new("INCOME_DIVIDENDS", "Dividends from investment accounts", "INCOME", null),
                ...
                new ("FOOD_AND_DRINK", null, null, new DefaultTransactionCategory[]{                    new("FOOD_AND_DRINK_BEER_WINE_AND_LIQUOR", "Beer, Wine & Liquor Stores", "FOOD_AND_DRINK", null),
                ...
                new ("GENERAL_MERCHANDISE", null, null, new DefaultTransactionCategory[]{                    new("GENERAL_MERCHANDISE_BOOKSTORES_AND_NEWSSTANDS", "Books, magazines, and news ", "GENERAL_MERCHANDISE", null),
                ...
                new ("PERSONAL_CARE", null, null, new DefaultTransactionCategory[]{                    new("PERSONAL_CARE_GYMS_AND_FITNESS_CENTERS", "Gyms, fitness centers, and workout classes", "PERSONAL_CARE", null),
                ...
                new ("TRANSFER_IN", null, null, new DefaultTransactionCategory[]{                    new("TRANSFER_IN_CASH_ADVANCES_AND_LOANS", "Loans and cash advances deposited into a bank account", "TRANSFER_IN", null),
                ...
                new ("LOAN_PAYMENTS", null, null, new DefaultTransactionCategory[]{                    new("LOAN_PAYMENTS_CAR_PAYMENT", "Car loans and leases", "LOAN_PAYMENTS", null),
                ...
                new ("HOME_IMPROVEMENT", null, null, new DefaultTransactionCategory[]{                    new("HOME_IMPROVEMENT_FURNITURE", "Furniture, bedding, and home accessories", "HOME_IMPROVEMENT", null),
                ...
                new ("GENERAL_SERVICES", null, null, new DefaultTransactionCategory[]{                    new("GENERAL_SERVICES_ACCOUNTING_AND_FINANCIAL_PLANNING", "Financial planning, and tax and accounting services", "GENERAL_SERVICES", null),
                ...
                new ("ENTERTAINMENT", null, null, new DefaultTransactionCategory[]{                    new("ENTERTAINMENT_CASINOS_AND_GAMBLING", "Gambling, casinos, and sports betting", "ENTERTAINMENT", null),
                ...
                new ("MEDICAL", null, null, new DefaultTransactionCategory[]{                    new("MEDICAL_DENTAL_CARE", "Dentists and general dental care", "MEDICAL", null),
                ...
                new ("TRAVEL", null, null, new DefaultTransactionCategory[]{                    new("TRAVEL_FLIGHTS", "Airline expenses", "TRAVEL", null),
                ...
                new ("TRANSFER_OUT", null, null, new DefaultTransactionCategory[]{                    new("TRANSFER_OUT_INVESTMENT_AND_RETIREMENT_FUNDS", "Transfers to an investment or retirement account, including investment apps such as Acorns, Betterment", "TRANSFER_OUT", null),
                ...
                new ("BANK_FEES", null, null, new DefaultTransactionCategory[]{                    new("BANK_FEES_ATM_FEES", "Fees incurred for out-of-network ATMs", "BANK_FEES", null),
                ...
                new ("TRANSPORTATION", null, null, new DefaultTransactionCategory[]{                    new("TRANSPORTATION_BIKES_AND_SCOOTERS", "Bike and scooter rentals", "TRANSPORTATION", null),
