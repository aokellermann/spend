...
import 'package:spend/core/init/init_di.dart';
import 'package:spend/core/init/init_user_auth.dart';
...
Future<void> main() async {
  ...
  await GetIt.I.get<GraphRepository>().initPlaid();
  await Translations
      .initApiTranslations(); // todo handle offline mode (or slow internet connection)
