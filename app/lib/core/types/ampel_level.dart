...
enum AmpelLevel { level1, level2, level3, level4, level5 }
...
extension AmpelLevelExtension on AmpelLevel {
  static AmpelLevel getAmpelLevelByInt(int level) {
    switch (level) {
      ...
      default:
        throw Exception(
            '[AmpelLevelExtension] getAmpelLevelByString: Invalid int level ($level)');
    }
  }
    ...
    switch (this) {
      ...
      case AmpelLevel.level2:
        return Container(
            ...
            child: SvgPicture.asset('assets/icons/ampel_system/Warning.svg',
                height: 34,
                colorFilter:
                    ColorFilter.mode(ampelColorHard, BlendMode.srcIn)));
      ...
      case AmpelLevel.level5:
        return Container(
            ...
            alignment: Alignment.centerLeft,
            child: SvgPicture.asset('assets/icons/ampel_system/Danger.svg',
                height: 32,
                colorFilter:
                    ColorFilter.mode(ampelColorHard, BlendMode.srcIn)));
    }
