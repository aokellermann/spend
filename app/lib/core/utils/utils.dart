...
import 'package:spend/presentation/components/modals/code_verification_modal.dart';
import 'package:spend/presentation/components/modals/data_privacy_modal.dart';
import 'package:spend/presentation/components/modals/delete_account_modal.dart';
...
class Utils {
    ...
    if (await canLaunchUrl(uri)) {
      ...
      if (context.mounted) {
        FlashMessageFactory.showFlashMessage(
            ...
            title: Translations.of(context)!.text('snackbar.url.not_openable'));
      }
    }
  }
  ...
  String getLangNameByCode(String langCode, BuildContext context) {
    switch (langCode) {
      ...
      default:
        throw Exception(
            '[Utils] languageName: Invalid language code: $langCode');
    }
  }
