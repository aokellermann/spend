...
class AuthUtils {
  ...
  Future<List<TextEditingController>?> pasteCodeFromClipboard(
      List<TextEditingController> digitControllers) async {
    ...
    if (clipboardText != null && clipboardText.length == 6) {
      try {
        ...
        debugPrint(
            '[_copyCodeFromClipboard] Cannot parse clipboard text to integer');
      }
    } else {
