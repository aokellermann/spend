...
class AuthConst {
  ...
  // Text styles
  static const TextStyle kTextFieldLabelTextStyle = TextStyle(
      fontSize: kTextFieldLabelFontSize, color: ColorPalette.textColor);
  static const TextStyle kTextFieldHintTextStyle = TextStyle(
      fontSize: kTextFieldHintFontSize, color: ColorPalette.textColorLight);
  static const TextStyle kTextFieldErrorTextStyle =
      TextStyle(fontSize: kTextFieldErrorFontSize, height: 1);
  static const TextStyle kTextFieldTextStyle = TextStyle(
      fontSize: kTextFieldFontSize,
      color: ColorPalette.textColor,
      textBaseline: TextBaseline.alphabetic);
  static const TextStyle kPrimaryButtonTextStyle = TextStyle(
      fontSize: 17.5, color: ColorPalette.white, fontWeight: FontWeight.w400);
  static const TextStyle kPrimaryButtonOutlinedTextStyle = TextStyle(
      fontSize: 17.5,
      color: ColorPalette.primaryColor,
  ...
  static const TextStyle kSecondaryButtonTextStyle = TextStyle(
      ...
      color: ColorPalette.primaryColor,
      fontWeight: FontWeight.w400);
  static const TextStyle kSecondaryButtonSmallTextStyle = TextStyle(
      fontSize: 13.5,
      color: ColorPalette.primaryColor,
      fontWeight: FontWeight.w400);
  static const TextStyle kCodeDigitFieldTextStyle = TextStyle(
      fontSize: 18, fontWeight: FontWeight.bold, color: ColorPalette.textColor);
  static const TextStyle kAuthModalTitleTextStyle = TextStyle(
      fontSize: 20, fontWeight: FontWeight.bold, color: ColorPalette.textColor);
  static const TextStyle kAuthModalInfoTextStyle = TextStyle(
      fontSize: 14,
      fontWeight: FontWeight.normal,
      color: ColorPalette.textColor);

  // Box Decorations
  static final BoxDecoration kPrimaryButtonBoxDecoration = BoxDecoration(
      borderRadius: BorderRadius.circular(kPrimaryButtonBorderRadius),
      color: ColorPalette.primaryColor);
  static final BoxDecoration kPrimaryButtonOutlinedBoxDecoration =
      BoxDecoration(
          borderRadius: BorderRadius.circular(kPrimaryButtonBorderRadius),
          color: ColorPalette.white,
          border: Border.all(color: ColorPalette.primaryColor, width: 1.4));
  static const BoxDecoration kAuthModalBoxDecorationShadow =
  ...
  static const BoxDecoration kAuthModalBoxDecoration = BoxDecoration(
      color: ColorPalette.white,
      borderRadius: BorderRadius.only(
          topLeft: Radius.circular(kAuthModalBorderRadius),
          topRight: Radius.circular(kAuthModalBorderRadius)));

  // Other
  static const Widget kPrimaryButtonLoadingSpinner = SpinKitThreeBounce(
      color: ColorPalette.white, size: kPrimaryButtonLoadingSpinnerSize);

  static const SizedBox kAuthModalTopGap =
