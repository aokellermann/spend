...
import 'package:spend/core/types/trend.dart';
import 'package:spend/core/types/trend_rating.dart';
...
class KPIUtils {
  ...
  static final List<KeyPerformanceIndex> defaultEnergyKPIs = [
    ...
    KeyPerformanceIndex(
        ...
        position: 1),
    KeyPerformanceIndex(
        name: 'produktionKkwCH',
        value: '70',
        route: NavigationRoute.energy,
        category: KPICategory.energy,
        position: 2),
    KeyPerformanceIndex(
        name: 'produktionKkwFR',
        value: '890',
        route: NavigationRoute.energy,
        category: KPICategory.energy,
        position: 3),
    KeyPerformanceIndex(
        name: 'speicherfuellstand',
        value: '84.6',
        route: NavigationRoute.energy,
        category: KPICategory.energy,
        position: 4),
    ...
    KeyPerformanceIndex(
        name: 'nettoImportExport',
        value: '-15',
        route: NavigationRoute.energy,
        category: KPICategory.energy,
        position: 5),
    KeyPerformanceIndex(
        name: 'aktuelleGesamteinsparung',
        value: '0',
        route: NavigationRoute.energy,
        category: KPICategory.energy,
        position: 6),
  ...
  static final List<KeyPerformanceIndex> defaultPriceKPIs = [
    ...
    KeyPerformanceIndex(
        ...
        position: 2),
    KeyPerformanceIndex(
        name: 'heizoelEntwicklung',
        value: '168',
        route: NavigationRoute.price,
        category: KPICategory.price,
        position: 3),
    KeyPerformanceIndex(
        name: 'treibstoffBenzin',
        value: '134',
        route: NavigationRoute.price,
        category: KPICategory.price,
        position: 4),
    KeyPerformanceIndex(
        name: 'treibstoffDiesel',
        value: '132',
        route: NavigationRoute.price,
        category: KPICategory.price,
        position: 5),
    KeyPerformanceIndex(
        name: 'brennholzEndverbrauch',
        value: '134',
        route: NavigationRoute.price,
        category: KPICategory.price,
        position: 6),
    KeyPerformanceIndex(
        name: 'fernwaermeEndverbrauch',
        value: '136',
        route: NavigationRoute.price,
        category: KPICategory.price,
        position: 7),
  ...
  static List<KeyPerformanceIndex> getDefaultKPIsByRoute(
    ...
    switch (category) {
      ...
      case KPICategory.price:
        return Translations.of(context)!
            .text('dashboard.preise.context-name.lang');
  ...
  List<KeyPerformanceIndex> deepCopyListOfKPIs(
      List<KeyPerformanceIndex> sourceList) {
  ...
  String getTitleByJsonKey(
      String key, KPICategory category, BuildContext context) {
    switch (key) {
      // Strom
      case 'aktuellerVerbrauch':
        if (category == KPICategory.energy) {
          return Translations.of(context)!
              .text('uebersicht_strom_verbrauch.titel');
        } else if (category == KPICategory.gas) {
          return Translations.of(context)!
              .text('uebersicht_gas_verbrauch.titel'); //unused
        } else {
          return '';
        }
      case 'gesamtProduktion':
        return Translations.of(context)!
            .text('uebersicht_strom_produktion.titel');
      case 'speicherfuellstand':
        return Translations.of(context)!
            .text('uebersicht_strom_speicherfüllstand-seen.titel');
      case 'nettoImport':
        if (category == KPICategory.energy) {
          return Translations.of(context)!
              .text('uebersicht_strom_import.titel');
        } else if (category == KPICategory.gas) {
          return Translations.of(context)!
              .text('uebersicht_gas_import.titel'); // unused
        } else {
          return '';
        }
      case 'nettoExport':
        return Translations.of(context)!
            .text('uebersicht_strom_export.titel'); // unused
      case 'nettoImportExport':
        return Translations.of(context)!
            .text('kpi-strom-9_import-export.titel');
      case 'aktuelleGesamteinsparung':
        if (category == KPICategory.energy) {
          return Translations.of(context)!
              .text('uebersicht_strom_mehr-minderverbrauch.titel');
        } else if (category == KPICategory.gas) {
          return Translations.of(context)!
              .text('uebersicht_gas_mehr-minderverbrauch.titel');
        } else {
          return '';
        }
      ...
      case 'fuellstandNachbarlaender':
        return Translations.of(context)!
            .text('uebersicht_gas_fuellstand-nachbarlaender.titel');
      case 'importEuropa':
      ...
      case 'strompreisKarteEuropa':
        return Translations.of(context)!
            .text('kpi-preise-8_strom_europa.titel');
      case 'gasBoerse':
        return Translations.of(context)!.text('dashboard.gas.context-name');
      ...
      case 'fernwaermeEndverbrauch':
        return Translations.of(context)!
            .text('dashboard.fernwaerme.context-name');
      // Wetter
      case 'aktuelleTemperatur':
        return Translations.of(context)!
            .text('uebersicht_wetter_aktuell.titel');
      case 'prognoseTemperatur':
        return Translations.of(context)!
            .text('uebersicht_wetter_prognose.titel'); // unused
      case 'schneereserven':
        return Translations.of(context)!
            .text('uebersicht_wetter_schneereserven.titel');
      case 'niederschlaege':
        return Translations.of(context)!
            .text('uebersicht_wetter_niederschlaege.titel');
      case 'heizgradtage':
        return Translations.of(context)!
            .text('uebersicht_wetter_heizgradtage.titel');
      default:
    ...
    switch (key) {
      ...
      case 'aktuellerVerbrauch':
        if (category == KPICategory.energy) {
          return GetIt.I
              .get<WebBaseHelper>()
              .getWebUrl(context: context, path: '/strom/stromverbrauch');
        } else if (category == KPICategory.gas) {
          return GetIt.I
              .get<WebBaseHelper>()
              .getWebUrl(context: context, path: '/gas/import'); // unused
        } else {
          return '';
        }
      case 'gesamtProduktion':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/strom/produktion');
      case 'speicherfuellstand':
        return GetIt.I.get<WebBaseHelper>().getWebUrl(
            context: context, path: '/strom/fuellstaende-speicherseen');
      case 'nettoImport':
        if (category == KPICategory.energy) {
          return GetIt.I
              .get<WebBaseHelper>()
              .getWebUrl(context: context, path: '/strom/import-export');
        } else if (category == KPICategory.gas) {
          return GetIt.I
              .get<WebBaseHelper>()
              .getWebUrl(context: context, path: '/gas/import'); // unussed
        } else {
          return '';
        }
      case 'nettoExport':
        return GetIt.I.get<WebBaseHelper>().getWebUrl(
            context: context, path: '/strom/import-export'); // unused
      case 'nettoImportExport':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/strom/import-export');
      case 'aktuelleGesamteinsparung':
        if (category == KPICategory.energy) {
          return GetIt.I
              .get<WebBaseHelper>()
              .getWebUrl(context: context, path: '/strom/minder-mehrverbrauch');
        } else if (category == KPICategory.gas) {
          return GetIt.I
              .get<WebBaseHelper>()
              .getWebUrl(context: context, path: '/gas/sparziel');
        } else {
          return '';
        }
      case 'produktionKkwCH':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/strom/kkw-ch');
      case 'produktionKkwFR':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/strom/kkw-fr');
      // Gas
      case 'fuellstandNachbarlaender':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/gas/eu-gasspeicher');
      case 'importEuropa':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/gas/import-europa');
      // Preise
      case 'stromBoerse':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/strom');
      case 'strompreisKarteEuropa':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/strom-karte');
      case 'gasBoerse':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/gas');
      case 'heizoelEntwicklung':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/oel');
      case 'treibstoffBenzin':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/treibstoff');
      case 'treibstoffDiesel':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/treibstoff');
      case 'brennholzEndverbrauch':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/brennholz');
      case 'fernwaermeEndverbrauch':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/preise/fernwaerme');
      // Wetter
      case 'aktuelleTemperatur':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/wetter/aktuell');
      case 'prognoseTemperatur':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/wetter/aktuell'); // unused
      case 'schneereserven':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/wetter/schneereserven');
      case 'niederschlaege':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/wetter/niederschlag');
      case 'heizgradtage':
        return GetIt.I
            .get<WebBaseHelper>()
            .getWebUrl(context: context, path: '/wetter/heizgradtage');
      default:
