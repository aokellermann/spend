...
class Navigation {
  ...
  static goToInformationDetails(InformationDetailsParameter extra) {
    Routes.goRouter
        .go('/overview/information/information_details', extra: extra);
  }
  ...
  static goToLanguages(context) {
    Routes.goRouter.go('/overview/information/languages',
        extra: Translations.of(context)?.locale);
  }
  ...
  static isNavBarPage(String location) {
    if (location.contains('/information') ||
