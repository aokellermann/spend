...
import 'package:spend/presentation/auth/registration/registration_footer.dart';
  ...
  Widget build(BuildContext context) {
    return AuthScaffold(
      header: Header(
          ...
          showSwissLogo: true),
      footer:
          RegistrationFooter(modalAnimationController: _animationController),
      body: [
        Padding(
          padding: const EdgeInsets.fromLTRB(
              0, Paddings.paddingS, 0, Paddings.paddingL),
          child: Text(
