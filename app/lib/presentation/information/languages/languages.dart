...
import 'package:spend/presentation/information/languages/languages_tile.dart';
...
class _LanguagesState extends State<Languages> {
        ...
        child: ValueListenableBuilder(
            ...
            builder: (context, locale, _) {
              return ListView.builder(
                itemCount:
                    GetIt.I.get<AppLocalization>().supportedLanguages.length,
  ...
  Future<void> _changeLanguage(int langIndex, context) async {
    ...
    localization.onLocaleChanged(
        Locale(localization.supportedLanguages[langIndex], ''));
    // update value notifier
    _currentLocale.value =
        Locale(localization.supportedLanguages[langIndex], '');
    // store new language
    final SharedPreferences _ = await SharedPreferences.getInstance()
      ..setString(Constants.kSharedPrefLanguageKey,
          localization.supportedLanguages[langIndex]);
  }
}
