...
import 'package:spend/presentation/components/kpi_card/kpi_card_category.dart';
import 'package:spend/presentation/components/kpi_card/kpi_card_chart.dart';
import 'package:spend/presentation/components/kpi_card/kpi_card_editor_row.dart';
import 'package:spend/presentation/components/kpi_card/kpi_card_title.dart';
import 'package:spend/presentation/components/kpi_card/kpi_card_value.dart';
...
class _KpiCardState extends State<KpiCard>
    with SingleTickerProviderStateMixin, KPICardMixin {
      ...
      child: GestureDetector(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                width: widget.editorMode
                    ? KPICardMixin.kKpiCardBorderWidthEditorMode
                    : KPICardMixin.kKpiCardBorderWidth,
                color: ColorPalette.kpiCardBorderColor),
          ),
          padding: EdgeInsets.all(widget.editorMode
              ? Paddings.paddingKpiCard -
                  KPICardMixin.kKpiCardBorderWidthEditorMode
              : Paddings.paddingKpiCard),
          child: Column(
            ...
            children: [
              ...
              // category
              if (widget.currentRoute == NavigationRoute.overview &&
                  !widget.editorMode)
                Flexible(
                  fit: FlexFit.loose,
                  flex: 2,
            ...
            Navigation.goToDetails(
              ...
              DetailsParameter(
                  ...
                  title: widget.kpi.category == KPICategory.price
                      ...
                      : KPIUtils().getTitleByJsonKey(
                          widget.kpi.name, widget.kpi.category, context),
                  url: KPIUtils().getDetailsUrlByJsonKey(
                      widget.kpi.name, widget.kpi.category, context)),
            );
