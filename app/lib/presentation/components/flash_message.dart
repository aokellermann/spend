    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Align(
          ...
          child: FlashMessage(title: title, type: type),
        ),
    ...
    return SlideTransition(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(
            horizontal: Paddings.paddingS, vertical: 12),
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                ...
                spreadRadius: 0,
                blurRadius: 10,
                color: ColorPalette.flashMessageShadowColor),
          ],
          border: widget.type == FlashMessageType.info
              ? Border.all(
                  color: ColorPalette.flashMessageInfoBorderColor, width: 1)
              : null,
        ),
        child: Row(
