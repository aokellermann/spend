...
class NavBarItems extends StatelessWidget with NavBarMixin {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      // for the show/hide nav bar purpose
      scrollDirection: Axis.vertical,
      physics: const NeverScrollableScrollPhysics(),
      child: Padding(
        padding: const EdgeInsets.fromLTRB(NavBarMixin.horizontalPadding,
            NavBarMixin.topPadding, NavBarMixin.horizontalPadding, 0),
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              icon: Padding(
                ...
                child: SvgPicture.asset('assets/icons/nav_bar/Overview.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.textColorLight, BlendMode.srcIn)),
              ),
              activeIcon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS),
                child: SvgPicture.asset(
                    'assets/icons/nav_bar/Overview-fill.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
              ...
              label: Translations.of(context)!
                  .text('navigation.mobile.title.home'),
            ),
            BottomNavigationBarItem(
              icon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS),
                child: SvgPicture.asset('assets/icons/nav_bar/Energy.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.textColorLight, BlendMode.srcIn)),
              ...
              activeIcon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS),
                child: SvgPicture.asset('assets/icons/nav_bar/Energy-fill.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.primaryColor, BlendMode.srcIn)),
            ...
            BottomNavigationBarItem(
              icon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS),
                child: SvgPicture.asset('assets/icons/nav_bar/Gas.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.textColorLight, BlendMode.srcIn)),
              ...
              activeIcon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS),
                child: SvgPicture.asset('assets/icons/nav_bar/Gas-fill.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.primaryColor, BlendMode.srcIn)),
            ...
            BottomNavigationBarItem(
              icon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS),
                child: SvgPicture.asset('assets/icons/nav_bar/Price-Trend.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.textColorLight, BlendMode.srcIn)),
              ...
              activeIcon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS),
                child: SvgPicture.asset(
                    'assets/icons/nav_bar/Price-Trend-fill.svg',
                    width: 24,
                    height: 24,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.primaryColor, BlendMode.srcIn)),
            ...
            BottomNavigationBarItem(
              icon: Padding(
                ...
                child: SvgPicture.asset('assets/icons/nav_bar/Weather.svg',
                    width: 26,
                    height: 26,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.textColorLight, BlendMode.srcIn)),
              ...
              activeIcon: Padding(
                padding: const EdgeInsets.only(bottom: Paddings.paddingXS - 2),
                child: SvgPicture.asset('assets/icons/nav_bar/Weather-fill.svg',
                    width: 26,
                    height: 26,
                    colorFilter: const ColorFilter.mode(
                        ColorPalette.primaryColor, BlendMode.srcIn)),
