    ...
    return GestureDetector(
      child: Transform.scale(
        ...
        child: Container(
          ...
          decoration: AuthConst.kPrimaryButtonBoxDecoration.copyWith(
              color: widget.isDisabled
                  ? ColorPalette.disabledButtonColor
          ...
          child: widget.isLoading
              ...
              : Text(
                  ...
                  style: AuthConst.kPrimaryButtonTextStyle.copyWith(
                      color: widget.isDisabled
                          ? ColorPalette.disabledButtonTextColor
                          : ColorPalette.white),
                ),
        ),
      ),
      ...
      onTapDown: (_) => !widget.isDisabled && !widget.isLoading
          ? AuthUtils().shrinkButtonSize(_animationController)
          : null,
