      ...
      children: [
                ...
                children: [
                  TextSpan(
                      text: Translations.of(context)!
                          .text('code-digit-field.label.enter-code')),
                  if (widget.hasSubtitle) const TextSpan(text: '\n'),
            ...
            for (int i = 0; i < AuthConst.kCodeDigits; i++)
              SizedBox(
                ...
                child: TextField(
                  ...
                  textInputAction: i < AuthConst.kCodeDigits - 1
                  ...
                  onChanged: (value) {
                    ...
                    } else if (i < AuthConst.kCodeDigits - 1 ||
                        value.length > 1) {
        ...
        SecondaryButton(
          title: Translations.of(context)!
              .text('code-digit-field.paste-code-from-clipboard'),
          callback: () async => await AuthUtils()
              .pasteCodeFromClipboard(_digitControllers)
              .then((digitControllers) {
