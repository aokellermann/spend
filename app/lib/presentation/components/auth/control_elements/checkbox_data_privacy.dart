...
class CheckboxDataPrivacy extends StatefulWidget {
  ...
  const CheckboxDataPrivacy(
      {super.key,
      required this.checkboxCallback,
      required this.openDataPrivacyModalCallback});
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            ...
            child: RichText(
              maxLines: 2,
              text: TextSpan(style: AuthConst.kTextFieldTextStyle, children: [
                TextSpan(
                  text: Translations.of(context)!
                      .text('checkbox.data-privacy.label'),
                ),
                WidgetSpan(
                    ...
                    child: GestureDetector(
                      ...
                      child: Text(
                        Translations.of(context)!
                            .text('checkbox.data-privacy.link'),
                        maxLines: 2,
                        style: AuthConst.kTextFieldTextStyle.copyWith(
