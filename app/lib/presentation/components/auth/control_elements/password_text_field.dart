                ...
                return TextField(
                  ...
                  onEditingComplete: () {
                    if (widget.inputAction == TextInputAction.next) {
                      ...
                      widget.focusNode
                          ?.nextFocus(); // one nextFocus would just focus the IconButton
                    } else {
                      widget.focusNode?.unfocus();
                    }
                  },
                  onChanged: (change) => widget.onChangeCallback != null
                      ? widget.onChangeCallback!(change)
                      : null,
                  maxLines: 1,
                  decoration: InputDecoration(
                    contentPadding: const EdgeInsets.all(
                        AuthConst.kTextfieldContentPadding),
                    ...
                    suffixIcon: Row(
                      ...
                      children: [
                        IconButton(
                          icon: SvgPicture.asset(
                            ...
                            colorFilter: const ColorFilter.mode(
                                ColorPalette.textFieldSuffixButtonColor,
                                BlendMode.srcIn),
                          ),
                          onPressed: () => _isVisible.value = !_isVisible.value,
                        ),
                        if (widget.errorText != null) Gaps.hSpacing3XS,
                        ...
                        if (widget.errorText != null) Gaps.hSpacingS
                      ],
                    ),
                  ),
