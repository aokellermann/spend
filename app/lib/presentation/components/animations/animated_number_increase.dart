...
class AnimatedNumberIncrease extends StatefulWidget with KPICardMixin {
  ...
  const AnimatedNumberIncrease(
      {super.key,
      required this.start,
      required this.end,
      this.duration =
          const Duration(milliseconds: KPICardMixin.kNumberIncreaseDurationMs),
...
class _AnimatedNumberIncreaseState extends State<AnimatedNumberIncrease>
      ...
      builder: (BuildContext context, Widget? child) {
        ...
        return Baseline(
          ...
          child: Text(
            ...
            style: KPICardMixin.kValueTextStyle.copyWith(
                color: ColorPalette.textColor
                    .withOpacity(widget.isDisabled ? 0.7 : 1)),
          ),
        );
      },
    );
