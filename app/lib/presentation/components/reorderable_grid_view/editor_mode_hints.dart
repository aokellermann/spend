...
class EditorModeHints extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: const EdgeInsets.fromLTRB(Paddings.paddingXXS,
          Paddings.paddingXXS, Paddings.paddingXXS, Paddings.paddingS),
      child: Column(
          ...
          Row(
            ...
            children: [
              Padding(
                ...
                child: SvgPicture.asset('assets/icons/kpi_card/drag-dots.svg',
                    width: 8.5,
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.only(
                      right: Paddings.paddingXS, bottom: Paddings.padding3XS),
                  child: SvgPicture.asset('assets/icons/kpi_card/star-fill.svg',
                      width: 15,
                      colorFilter: const ColorFilter.mode(
                          ColorPalette.textColorLight, BlendMode.srcIn)),
                ),
              ...
              children: [
                Padding(
                  ...
                  child: SvgPicture.asset(
                      'assets/icons/kpi_card/circle-minus.svg',
                      width: 15,
                      colorFilter: const ColorFilter.mode(
                          ColorPalette.textColorLight, BlendMode.srcIn)),
                ),
