...
class AmpelSystemTabs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin:
          const EdgeInsets.only(top: AmpelSystemMixin.kAmpelSystemBorderWidth),
      child: Row(
          ...
          for (var l in AmpelLevel.values) ...[
            ClipRRect(
              ...
              child: Container(
                ...
                height: l == ampel.level
                    ? AmpelSystemMixin.kAmpelSystemTabHeightActive
                    : AmpelSystemMixin.kAmpelSystemTabHeightInactive,
                margin: l != ampel.level
                    ? const EdgeInsets.only(
                        bottom: AmpelSystemMixin.kAmpelSystemBorderWidth)
                    : null,
                decoration: BoxDecoration(
                  color: l == ampel.level ? l.ampelSoftColor : l.ampelColorTab,
                  border: l == ampel.level
                      ? Border(
                          left: BorderSide(
                              width:
                                  AmpelSystemMixin.kAmpelSystemTabsBorderWidth,
