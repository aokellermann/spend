            ...
            return Container(
              ...
              child: AnimatedContainer(
                ...
                margin: const EdgeInsets.only(
                    top: AmpelSystemMixin.kAmpelSystemTabsHeight),
                padding: const EdgeInsets.only(
                    left: Paddings.paddingXS, right: Paddings.paddingS),
                          ...
                          Expanded(
                            child: Text(
                              Translations.of(context)!.text(
                                  '${getAmpelTranslationKeyPrefix(ampel)}.titel'),
                              overflow: TextOverflow.ellipsis,
                              style: const TextStyle(
                                  fontWeight: FontWeight.bold, fontSize: 14.8),
                            ),
                          ),
                        ],
                      ),
                    ...
                    Padding(
                      ...
                      child: expanded
                          ? Icon(Icons.clear_rounded,
                              size: 20, color: ampel.level.ampelColorMedium)
                          : Icon(Icons.info,
                              size: 20, color: ampel.level.ampelColorMedium),
                    ),
                  ],
